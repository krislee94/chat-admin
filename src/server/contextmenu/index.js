;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global.VContextmenu = {}), global.Vue))
  ...
  var unbind = function unbind(el, binding) {
    ...
    contextmenuRef === null || contextmenuRef === void 0
      ? void 0
  ...
  var Contextmenu = vue.defineComponent({
    ...
    setup: function setup(props, _ref) {
      ...
      var show = function show(evt, options) {
        ...
        var targetPosition = {
          top:
            (targetOptions === null || targetOptions === void 0 ? void 0 : targetOptions.top) || 0,
          left:
      ...
      return vue.createVNode(
        'i',
        {
          class: [
            ...
            ''.concat(CLASSES.contextmenuIcon, '-').concat(this.name)
          ]
        },
        null
      )
